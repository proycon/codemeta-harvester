FROM alpine:latest
RUN apk add python3 py3-pip py3-yaml py3-ruamel.yaml py3-requests py3-scikit-learn py3-pandas py3-matplotlib py3-markdown py3-rdflib py3-lxml git dasel curl
